<x-layoutadmin>
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.subscriptions.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">Crear Suscripción</a>
        </div>
            ...
            <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-sm">
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 text-center">
                        <a href="{{ route('admin.subscriptions.edit', $sub->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded-lg shadow-sm hover:bg-yellow-600 transition duration-300">Editar</a>
