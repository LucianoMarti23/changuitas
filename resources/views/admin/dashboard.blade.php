<x-layoutadmin>
    ...
    <!-- Contenido Principal -->
    <main class="flex-1 p-6 bg-dark-100">


        <!-- Contenido del dashboard -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Ejemplo de tarjetas de contenido -->
            <div class="flex bg-light-50 p-1 rounded-lg shadow-md">
                <div class="flex w-1/4 items-center justify-center rounded-lg bg-primary-300">
                    <svg class="w-12 h-12 text-primary-600 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex bg-light-50 p-1 rounded-lg shadow-md">
                <div class="flex w-1/4 items-center justify-center rounded-lg bg-primary-300">
                    <svg class="w-12 h-12 text-primary-600 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
