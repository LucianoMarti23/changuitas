                        ...
                        <div
                            ...
                            <div id="myModal"
                                ...
                                <div class="modal-content bg-white p-6 rounded-lg w-[90%] max-w-md relative">
                                    ...
                                    <span id="closeModal"
                                        class="absolute top-2 right-2 text-2xl cursor-pointer text-gray-700">×</span>
                ...
                <form id="contactForm">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="message" name="message" rows="4"
                            class="w-full p-2 mt-1 border border-gray-300 rounded-md" required></textarea>
                    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="text-left">
                            <button type="button" id="cancelContactModal"
                                class="bg-gray-300 text-gray-800 py-2 px-4 rounded-md">Cancelar</button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div id="experienceContent" class="mb-4">
                    ...
                    @foreach($workExperiences as $workExperience)
                        <div class="bg-white shadow-lg rounded-lg p-6 cursor-pointer work-experience transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:ring hover:ring-blue-300"
                            ...
                            <p class="text-gray-500 text-sm">Inicio:
                                {{ \Carbon\Carbon::parse($workExperience->start_date)->format('d/m/Y') }}</p>
                            <p class="text-gray-500 text-sm">
                                Finalización:
                                {{ $workExperience->end_date ? \Carbon\Carbon::parse($workExperience->end_date)->format('d/m/Y') : 'Actualidad' }}
                            </p>
                        </div>
                    @endforeach
