<x-page>
                    ...
                    <div class="relative flex flex-col space-y-4"> <!-- Cambié a flex-col para apilar verticalmente -->
                        ...
                        <div>
                            <label for="selectCategory"
                                class="text-sm sm:text-base font-medium text-dark-500 mb-2">Categoría</label>
                        ...
                        <div>
                            <label for="modality"
                                class="text-sm sm:text-base font-medium text-dark-500 mb-2">Modalidad</label>
                            <select id="modality" name="modality"
                                class="form-input w-full border border-dark-300 rounded-lg py-2 px-3" required>
                        ...
                        <div>
                            ...
                            <select id="work_schedule" name="work_schedule" class="mt-1 block form-input w-full"
                                required>
                ...
                <div
                    ...
                    <div class="flex items-center pb-8 justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <p class="text-sm sm:text-base text-complem-600 flex items-center space-x-1">
                                <span class="hidden text-base font-semibold sm:block">Promocionada</span>
                    ...
                    <div class="flex flex-col mb-1">
                        ...
                        <div class="flex items-center text-base pl-2 text-dark-400 dark:text-dark-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                ...
                                <path
                                    d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM8 13c-2.967 0-5.5-2.239-5.5-5S5.033 3 8 3s5.5 2.239 5.5 5-2.533 5-5.5 5zm0-1a4 4 0 1 1 0-8 4 4 0 0 1 0 8z" />
                        ...
                        <div
                            class="text-md sm:text-xl pt-2 text-dark-700 dark:text-dark-200 w-64 overflow-hidden text-ellipsis line-clamp-2">
    ...
    <div id="modal" class="fixed inset-0 bg-dark-800 bg-opacity-75 flex items-center justify-center hidden">
        <div
            class="bg-light-200 dark:bg-light-700 text-dark-800 dark:text-dark-200 p-4 rounded-lg shadow w-full lg:w-1/3 max-h-[90vh] overflow-y-auto">
            <div class="flex items-center pb-8 justify-between">
                <div class="flex items-center">
                    <!-- foto -->
                    <div class="relative w-12 h-12">
                        <img src="" alt="Foto de usuario" class="object-cover w-full h-full rounded-full">
                    </div>
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div>
                        <label for="job_description"
                            class="block text-dm font-medium text-dark-700 dark:text-dark-200">Descripción del
                            trabajo</label>
                    ...
                    <div>
                        <label for="job_requirements"
                            class="block text-dm font-medium text-dark-700 dark:text-dark-200">Requisitos</label>
                        <textarea id="job_requirements" name="job_requirements" rows="4"
                            class="mt-1 block w-full rounded-md p-2 text-dark-700 text-sm sm:text-dm"
                            required></textarea>
                    </div>
