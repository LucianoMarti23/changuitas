...
<section class="relative w-full h-screen">
    <div class="bg-blue-500 text-white p-4">
        <div class="container mx-auto">
            <img src="/img/Alert/Error-pag-A.png" alt="Banner" class="w-full h-auto mb-4">
            <div class="error">Error 503: Servicio No Disponible.</div>
        </div>
    </div>
</section>
...
<body class=" text-light-200  bg-dark-900">
    <section class="relative w-full h-screen flex items-center justify-center  text-white">
        <div class="relative w-full max-w-4xl mx-auto">
            <img src="/img/Alert/Error-pag-B.png" alt="errorBanner" class="w-full h-auto max-w-full">
            <div class="absolute inset-0 px-4  flex flex-col justify-center  text-center  ">
                <div class="bg-dark-800  bg-opacity-70 p-6 rounded-md inline-block">
                    ...
                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-semibold mb-4"> Servicio No Disponible.</h3>
                    <p class="text-base sm:text-lg lg:text-xl font-semibold mb-6">El servidor está temporalmente fuera de servicio para mantenimiento o actualizaciones.</p>
                    <div class="pt-4">
