...
<section class="relative w-full h-screen">
    <div class="bg-blue-500 text-white p-4">
        <div class="container mx-auto">
            ...
            <div class="error">Lo sentimos, la página que estás buscando no existe.</div>
        </div>
    </div>
</section>
        ...
        <div class="relative w-full max-w-4xl mx-auto">
            ...
            <div class="absolute inset-0 px-4  flex flex-col justify-center  text-center  ">
                <div class="bg-dark-800  bg-opacity-70 p-6 rounded-md inline-block">
                    ...
                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-semibold mb-4"> Lo sentimos, la página que estás buscando no existe.</h3>
