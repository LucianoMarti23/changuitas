        ...
        <div class="relative w-full max-w-4xl mx-auto">
            ...
            <div class="absolute inset-0 px-4  flex flex-col justify-center  text-center  ">
                <div class="bg-dark-800  bg-opacity-70 p-6 rounded-md inline-block">
                    ...
                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-semibold mb-4"> Demasiadas Solicitudes</h3>
                    <p class="text-base sm:text-lg lg:text-xl font-semibold mb-6">Has realizado demasiadas solicitudes en un corto período de tiempo. 
                    Por favor, espera unos momentos antes de intentar nuevamente.</p>
                    <div class="pt-4">
