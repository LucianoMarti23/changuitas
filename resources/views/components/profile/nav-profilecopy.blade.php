<nav>
    ...
    <div
        class="fixed top-0 left-0 w-1/5 h-screen pl-4 pb-4 pt-32 shadow-md dark:shadow-[0_0_10px_theme(colors.primary.700/50%)]">
        <ul class="space-y-1">
            <li>

                <a href="{{ route('profile.personalData', Auth::id())}}"
            ...
            <li>
                <a href="{{route('work_experiences.index')}}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 mr-2 inline-block hover:fill-light-100"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M21 7h-4V4c0-1.1-.9-2-2-2H9C7.9 2 7 2.9 7 4v3H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zM9 4h6v3H9V4zm10 16H5V9h14v11z" />
                    </svg>
                    Experiencia Laboral
            ...
            <li>
                <a href="{{ route('profile.publicaciones')}}"
                    class="block  text-normal text-lg hover:bg-primary-800 hover:text-light-200 rounded-full rounded-r-none pl-2 py-1">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100.000000pt" height="100.000000pt"
                        viewBox="0 0 100.000000 100.000000" class="w-7 h-7 mr-2 inline-block hover:fill-light-100 "
                        preserveAspectRatio="xMidYMid meet">
            ...
            <li>
                <a href="{{route('notificaciones.index')}}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 mr-2 inline-block hover:fill-light-100"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M12 22a2 2 0 002-2h-4a2 2 0 002 2zM18 10V9a6 6 0 00-12 0v1c0 3.25-2.55 6-5 6h2l1 4h14l1-4h2c-2.45 0-5-2.75-5-6z" />
                    </svg>
                    Notificaciones
